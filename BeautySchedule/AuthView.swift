...
struct SignIn : View {
    ...
    var authServiceVar = AuthService()
        ...
        VStack {
            VStack{
                ...
                Button(action: {
                    ...
                    authServiceVar.signInWithEmail(email: self.user, password: self.pass) { (verified, status) in
    ...
    var body : some View{
        ...
        VStack{
            ...
            Button(action: {
                ...
                authServiceVar.signUpWithEmail(email: self.user, password: self.pass) { (verified, status) in
